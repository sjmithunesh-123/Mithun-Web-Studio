...
import { MessageCircle, X, Menu, Mail, Linkedin, Github, Star, Briefcase, Code2, Layout, User, Wrench, Sparkles, ArrowRight, ExternalLink, Phone, MapPin, CheckCircle2 } from "lucide-react";
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-4", children: [
          /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-primary font-display text-lg font-bold text-primary-foreground", children: /* @__PURE__ */ jsx("img", { src: "/logo.png", alt: "Logo" }) }),
            /* @__PURE__ */ jsxs("span", { className: "font-display text-lg font-semibold", children: [
              "Mithun Web Studio",
              /* @__PURE__ */ jsx("span", { className: "text-primary", children: "." })
            ] })
          ] }),
          /* @__PURE__ */ jsx("nav", { className: "hidden items-center gap-8 md:flex", children: links.map((l) => /* @__PURE__ */ jsx(
            Link,
            {
              to: l.to,
          ...
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4", fill: "currentColor", strokeWidth: 0 }),
                "WhatsApp"
              ]
            }
          ),
        ...
        open && /* @__PURE__ */ jsx("div", { className: "glass border-t border-border/50 md:hidden", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 px-6 py-4", children: [
...
function Hero() {
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 -z-10", children: /* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-1/3 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-primary/20 blur-[120px]" }) }),
        /* @__PURE__ */ jsxs("div", { className: "mx-auto grid w-full max-w-7xl gap-12 px-6 py-20 md:grid-cols-[1.2fr_1fr] md:items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-6 inline-flex items-center gap-2 rounded-full border border-border/70 bg-card/40 px-4 py-1.5 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-primary" }),
              "Available for freelance projects"
            ] }),
            /* @__PURE__ */ jsxs("h1", { className: "text-5xl font-bold leading-[1.05] sm:text-6xl md:text-7xl", children: [
              "Professional Websites for Modern Businesses ",
              /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "Building Websites That Grow Your Business." })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-6 max-w-xl text-lg text-muted-foreground", children: /* @__PURE__ */ jsx("span", { className: "text-foreground font-medium", children: "Hi, I'm Mithunesh S - a freelance web developer helping businesses, startups, and creators build professional websites that drive growth and create a strong online presence." }) }),
            /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(MessageCircle, { className: "h-5 w-5", fill: "currentColor", strokeWidth: 0 }),
                    "Chat on WhatsApp",
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-12 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-muted-foreground", children: ["50+ Projects", "5★ Rated", "24h Response"].map((s) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-primary" }),
              s
            ] }, s)) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "relative animate-fade-up", style: { animationDelay: "0.2s" }, children: /* @__PURE__ */ jsx("div", { className: "absolute -bottom-6 -right-6 animate-float rounded-2xl border border-border/70 bg-card px-4 py-3 shadow-card", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "flex h-8 w-8 items-center justify-center rounded-full bg-whatsapp/20 text-whatsapp", children: /* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4", fill: "currentColor", strokeWidth: 0 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "font-medium", children: "Let's talk" }),
              /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: "Replies in minutes" })
            ] })
          ] }) }) })
        ] })
      ]
...
function About() {
  ...
  return /* @__PURE__ */ jsx("section", { id: "about", className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-12 md:grid-cols-2 md:items-center", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(SectionLabel, { icon: User, children: "About Me" }),
      /* @__PURE__ */ jsxs("h2", { className: "mt-4 text-4xl font-bold sm:text-5xl", children: [
        "Turning ideas into ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "digital experiences" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-6 text-muted-foreground", children: "I'm a freelance web developer focused on building polished, high-performance websites that help businesses look credible and win customers online. From single landing pages to full business websites, I handle design, development, and deployment end-to-end." }),
      /* @__PURE__ */ jsxs("p", { className: "mt-4 text-muted-foreground", children: [
        "My stack: ",
        /* @__PURE__ */ jsx("span", { className: "text-foreground", children: "React, Next.js, TypeScript, Tailwind CSS, Node.js" }),
        ". My priority: clean code, fast load times, and designs that actually convert visitors into customers."
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-4", children: stats.map((s) => /* @__PURE__ */ jsxs(
      "div",
      {
...
function Services() {
  return /* @__PURE__ */ jsx("section", { id: "services", className: "border-y border-border/40 bg-card/20 py-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl text-center", children: [
      /* @__PURE__ */ jsx(SectionLabel, { icon: Briefcase, children: "Services" }),
      /* @__PURE__ */ jsxs("h2", { className: "mt-4 text-4xl font-bold sm:text-5xl", children: [
        "What I can build ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "for you" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-4 text-muted-foreground", children: "End-to-end web development services tailored to your goals and budget." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: services.map((s) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-primary text-primary-foreground", children: /* @__PURE__ */ jsx(s.icon, { className: "h-6 w-6" }) }),
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold", children: s.title }),
...
function Portfolio() {
  return /* @__PURE__ */ jsx("section", { id: "portfolio", className: "py-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-end justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(SectionLabel, { icon: Layout, children: "Portfolio" }),
        /* @__PURE__ */ jsxs("h2", { className: "mt-4 text-4xl font-bold sm:text-5xl", children: [
          "Recent ",
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: projects.map((p) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "font-display text-5xl font-bold text-foreground/30", children: p.title.charAt(0) }) }),
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 transition-opacity group-hover:opacity-100" }),
                /* @__PURE__ */ jsx("span", { className: "absolute right-3 top-3 rounded-full bg-background/70 px-3 py-1 text-xs backdrop-blur", children: p.tag })
              ]
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "p-5", children: [
            /* @__PURE__ */ jsx("h3", { className: "flex items-center gap-2 font-semibold", children: p.title }),
...
function Testimonials() {
  return /* @__PURE__ */ jsx("section", { id: "testimonials", className: "border-y border-border/40 bg-card/20 py-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl text-center", children: [
      /* @__PURE__ */ jsx(SectionLabel, { icon: Star, children: "Testimonials" }),
      /* @__PURE__ */ jsxs("h2", { className: "mt-4 text-4xl font-bold sm:text-5xl", children: [
        "What clients ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "say" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mt-14 grid gap-6 md:grid-cols-3", children: testimonials.map((t) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "rounded-2xl border border-border/70 bg-card/60 p-6 shadow-card",
        children: [
          /* @__PURE__ */ jsx("div", { className: "flex gap-1 text-primary", children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: "h-4 w-4", fill: "currentColor", strokeWidth: 0 }, i)) }),
          /* @__PURE__ */ jsxs("p", { className: "mt-4 text-muted-foreground", children: [
            '"',
            t.quote,
            '"'
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6 flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-gradient-primary font-semibold text-primary-foreground", children: t.name.charAt(0) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "font-medium", children: t.name }),
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxs("section", { id: "contact", className: "relative overflow-hidden py-24", children: [
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 -z-10 bg-gradient-hero opacity-60" }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx(SectionLabel, { icon: Mail, children: "Get in touch" }),
        /* @__PURE__ */ jsxs("h2", { className: "mt-4 text-4xl font-bold sm:text-5xl", children: [
          "Have a project? ",
          /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "Let's build it." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mx-auto mt-4 max-w-xl text-muted-foreground", children: "Fastest way to reach me is WhatsApp. I usually reply within a few hours." }),
        /* @__PURE__ */ jsxs(
          "a",
          {
            href: whatsappLink(),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-14 grid gap-8 lg:grid-cols-[1.1fr_1fr]", children: [
        /* @__PURE__ */ jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold", children: "Send a message" }),
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Fill the form — it opens WhatsApp with your message pre-filled." }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: items.map((i) => /* @__PURE__ */ jsxs(
          "a",
          {
            href: i.href,
            target: "_blank",
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "mt-4 text-sm text-muted-foreground", children: i.label }),
              /* @__PURE__ */ jsx("div", { className: "mt-1 font-medium", children: i.value })
            ]
          },
          i.label
        )) })
...
function Footer() {
  return /* @__PURE__ */ jsx("footer", { className: "border-t border-border/40 bg-background py-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid gap-8 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-primary", children: "Mithunesh S" }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Professional Web Developer creating modern, responsive and business-focused websites." })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-3", children: "Quick Links" }),
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/portfolio", children: "Portfolio" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/contact", children: "Contact" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-3", children: "Services" }),
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsx("li", { children: "Website Development" }),
          /* @__PURE__ */ jsx("li", { children: "Landing Pages" }),
          /* @__PURE__ */ jsx("li", { children: "Portfolio Websites" }),
          /* @__PURE__ */ jsx("li", { children: "Business Websites" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-3", children: "Contact" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-10 border-t border-border/30 pt-6 text-center text-sm text-muted-foreground", children: [
      "© ",
...
function SectionLabel({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-border/70 bg-card/40 px-3 py-1 text-xs uppercase tracking-wider text-muted-foreground", children: [
...
function FloatingWhatsApp() {
  return /* @__PURE__ */ jsxs(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(MessageCircle, { className: "h-7 w-7", fill: "currentColor", strokeWidth: 0 }),
        /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Chat on WhatsApp" })
      ]
    }
  );
}
...
const $$splitComponentImporter$5 = () => import("./testimonials-BiQeZ2w1.js");
...
const $$splitComponentImporter$4 = () => import("./services-B6thvRAj.js");
...
const $$splitComponentImporter$3 = () => import("./portfolio-uIL4TIPO.js");
...
const $$splitComponentImporter$2 = () => import("./contact-CnTBoHC2.js");
...
const $$splitComponentImporter$1 = () => import("./about-Bc8OV5XL.js");
...
const $$splitComponentImporter = () => import("./index-B9NxQMPF.js");
